...
{     int i,j;
	...
	{  
		...
		{ 
			...
			array_b[i][j].omega = space_array[i][j].omega;
			array_b[i][j].teta = space_array[i][j].teta;
			array_b[i][j].psi = space_array[i][j].psi;
			array_b[i][j].health = space_array[i][j].F_omega;
			array_b[i][j].health = space_array[i][j].F_teta;
...
{     int i,j;
	...
	{  
		for (j = 1; j < hor_size; j++)
		{ 
			/*array_b1[i][j].temperature=array_b[i][j].temperature;
			array_b1[i][j].oxygen=array_b[i][j].oxygen;
			array_b1[i][j].life_exist=array_b[i][j].life_exist;
			array_b1[i][j].t_resistance=array_b[i][j].t_resistance;
			array_b1[i][j].o_resistance=array_b[i][j].o_resistance;
			array_b1[i][j].gender = array_b[i][j].gender;
			array_b1[i][j].health = array_b[i][j].health;
			array_b1[i][j].omega = array_b[i][j].omega;
			array_b1[i][j].teta = array_b[i][j].teta;
			array_b1[i][j].psi = array_b[i][j].psi;
			array_b1[i][j].health = array_b[i][j].F_omega;
			array_b1[i][j].health = array_b[i][j].F_teta;*/
